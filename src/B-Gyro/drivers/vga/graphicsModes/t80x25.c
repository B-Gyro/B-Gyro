...
volatile uint8_t* bda = (volatile uint8_t*) 0x4000;

void	set_screen_parameters(uint16_t cols, uint16_t rows, uint8_t char_height) {
    *((volatile uint16_t*)(bda + 0x4A)) = cols;
    *((volatile uint16_t*)(bda + 0x4C)) = cols * rows * 2;
    *((volatile uint16_t*)(bda + 0x50)) = 0;
    *((volatile uint8_t*)(bda + 0x60)) = char_height - 1;
    *((volatile uint8_t*)(bda + 0x61)) = char_height - 2;
    *((volatile uint8_t*)(bda + 0x84)) = rows - 1;
    *((volatile uint8_t*)(bda + 0x85)) = char_height;
...
_vgaMode	*changeVGAModeT80x25(void){
	...
	set_screen_parameters(80, 25, 16);
	return &g_T80x25;
}